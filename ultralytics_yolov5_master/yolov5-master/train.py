...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='yolov5s_CBAM.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / './guo_shu1.v11i.yolov5pytorch/data.yaml', help='dataset.yaml path')
